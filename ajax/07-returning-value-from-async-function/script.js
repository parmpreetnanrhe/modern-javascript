...
btn.addEventListener("click", (event) => {
  ...
  //   getCountryData(`${countryByNameURL}china`, true); // will load data (but doesn't ensure that neighbouring country will be loading instantly )
  (async function () {
    // will load data (and ensures that neighbouring country will be loading instantly )
    await getCountryData(`${countryByNameURL}china`, true);
    await getCountryData(`${countryByNameURL}france`, true);
  })();
});
